...
#endif
#ifndef SDL_revcpy
extern void * SDL_revcpy(void *dst, const void *src, size_t len);
#endif
...
#else
extern long SDL_strtol(const char *string, char **endp, int base);
#endif

#ifdef HAVE_STRTOUL
#define SDL_strtoul      strtoul
#else
extern unsigned long SDL_strtoul(const char *string, char **endp, int base);
#endif
...
#else
extern Sint64 SDL_strtoll(const char *string, char **endp, int base);
#endif

#ifdef HAVE_STRTOULL
#define SDL_strtoull     strtoull
#else
extern Uint64 SDL_strtoull(const char *string, char **endp, int base);
#endif
